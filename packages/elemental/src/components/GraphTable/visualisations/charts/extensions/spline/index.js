 ...
 * and don't want to pass utilityFns for small change in existing output
...
export function getChartConfig(reportConfig) {
    ...
    const updatedChartConfig = merge(chartConfig, reportConfig?.getHardOverrideChartConfig ? reportConfig.getHardOverrideChartConfig(chartConfig, reportConfig) : {});
