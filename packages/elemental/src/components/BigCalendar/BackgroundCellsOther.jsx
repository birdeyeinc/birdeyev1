...
class BackgroundCellsOther extends React.Component {
        ...
        return (
            <div className="rbc-row-bg" ref={this.containerRef}>
                {range.map((date, index) => {
                    ...
                    "rbc-off-range-bg",
                                    isSocial &&  new Date( date ).setHours(0,0,0,0) < new Date( getNow() ).setHours(0,0,0,0) && "past-dates"
                                )}
                            />
                        </Wrapper>
                    );
...
BackgroundCellsOther.propTypes = {
...
export default BackgroundCellsOther;