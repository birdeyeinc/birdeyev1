...
function TimeGridEvent(props) {
    ...
    const eventStyle = isBackgroundEvent
        ? {
            ...userProps.style,
            top: (eventPositionInPercent && eventPositionInPercent === true) ? stringifyPercent(top) : top < 1 ? "0px" : top * 145 + "px",
            //top: top < 1 ? "0px" : top * 110 + "px",
        ...
        // xole.log(" event style "+JSON.stringify(eventStyle));
