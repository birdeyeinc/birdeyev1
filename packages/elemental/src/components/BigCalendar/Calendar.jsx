...
class Calendar extends React.Component {
  static propTypes = {
     ...
     */
      ...
      /**
     * Maximum number of events to show in month view before
     * displaying "+X more". If not set, it will be calculated
     * based on available row height.
     */
     ...
     */
      ...
      /**
       * Permission object of rolebaseKey `social/social_publish/actions`
       */
  ...
  static defaultProps = {
      ...
      addAppointmentClass: false,
      allowDiffDateEvents: false,
      permissions: {}
  }
  ...
  getDrilldownView = (date) => {
    ...
    getViewWidth = () => {
        const viewDivWidth = window.innerWidth;
        return viewDivWidth - 40;
    };
  ...
  render() {
      ...
      const activeView = window.localStorage.getItem("activeView");
      const customCalendarStyle = activeView === "list" ? { height: "100%" } : {};
      return (
          <div
              {...elementProps}
              className={clsx(className, "rbc-custom-style rbc-calendar", props.rtl && "rbc-rtl", addAppointmentClass && "appointment-calendar")}
          ...
          >
              {toolbar && (
                  <CalToolbar
                      ...
                      localizer={localizer}
                      setShowDatePicker={this.props.setShowDatePicker}
                      year={moment(this.props.date).format("YYYY")}
                      showOnlyDayWeekView={this.props.showOnlyDayWeekView}
                      hideCalendarText={this.props.hideCalendarText}
                      isSocial={this.props.isSocial}
                      renderCustomJSXToolbar={renderCustomJSXToolbar}
                      viewWidth={viewWidth|| this.getViewWidth()}
                      showListView={showListView}
                      customRangeToolbar={customRangeToolbar}
                      hideArrows={hideArrows}
                      bestTimeAIToggle={bestTimeAIToggle}
                      getActionMenu={getActionMenu}
                      showAIBestTimeToggleHandler={showAIBestTimeToggleHandler}
                  />
              )}
              <View
                  {...props}
                  ...
                  addAppointmentClass={addAppointmentClass}
  ...
  handleViewChange = (view, action) => {
      if (action === "triggerViewChange" && isValidView(view, this.props)) {
