...
const CustomBaseNode = ({ data, selected }) => {
    ...
    const sourceHandleData = [
        { id: 'source-bottom', position: Position.Bottom, style: { visibility: 'hidden' } }
    ];
...
const CustomBaseEdge = ({ id, sourceX, sourceY, targetX, targetY, sourcePosition, targetPosition, style: edgeStyle, markerEnd }) => {
...
// ============================================
// Story Template with ZoomPopover
// ============================================

const WorkflowCanvasWithZoom = (args) => {
                ...
                panels={[
                    {
                        ...
                        content: (
                            <ZoomPopover
                                ...
                                isVertical={args.layoutMode === 'vertical'}
                            />
                        ),
                    },
                ]}
...
export const Default = {
    render: (args) => <WorkflowCanvasWithZoom {...args} />,
    args: {
        layoutMode: 'vertical',
        invokeFitView: true,
        fitViewConfig: {
