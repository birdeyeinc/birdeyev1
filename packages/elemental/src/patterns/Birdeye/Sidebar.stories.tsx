...
import {
  ...
  InboxL2NavPanel,
} from "@birdeye/components/Sidebar";
import { ReviewsL2NavPanel as ReviewsL2NavPanelV1 } from "@birdeye/components/Sidebar.v1";
import { ReviewsL2NavPanel as ReviewsL2NavPanelV2 } from "@birdeye/components/Sidebar.v2";
import { SidebarSectioned } from "@birdeye/components/SidebarSectioned.v1";
import { AgentsL2NavPanel as AgentsL2NavPanelV1 } from "@birdeye/components/AgentsL2NavPanel.v1";
import { AgentsL2NavPanel as AgentsL2NavPanelV2 } from "@birdeye/components/AgentsL2NavPanel.v2";
import { APP_SHELL_GUTTER_SURFACE_CLASS } from "@birdeye/components/layout/appShellClasses";
import { MonitorNotificationsProvider } from "@birdeye/context/MonitorNotificationsContext";
import type { AppView } from "@birdeye/App";
import { CONTACTS_L2_KEY_ALL } from "@birdeye/components/ContactsView";
import { SEARCH_AI_L2_DEFAULT_ACTIVE } from "@birdeye/components/searchai/searchAIL2Keys";
