...
function SocialMonthGrid({
  ...
  return (
    <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden text-xs leading-normal">
      <div className="flex min-h-0 flex-1 flex-col overflow-x-auto">
        <div className="grid shrink-0 grid-cols-7 border-b border-border bg-background min-w-[560px]">
        ...
        <div className="min-h-0 flex-1 overflow-hidden min-w-[560px]">
          <div
...
export function SocialView({ activeItem: _activeItem, onActiveItemChange: _onChange }: SocialViewProps = {}) {
  ...
  const initialFilters = useMemo<FilterItem[]>(
    () => [
      {
        id: "platform",
        label: "Platform",
        value: "All platforms",
        options: ["All platforms", "Facebook", "Instagram", "X", "Google"],
      },
      {
        id: "status",
        label: "Status",
    ...
    <div className="flex min-h-0 flex-1 flex-col overflow-hidden bg-background transition-colors duration-300">
      ...
      <div className="flex min-h-0 flex-1 overflow-hidden">
        ...
        <FilterPane
          ...
          storageKey="social:view:filters"
          title="Filters"
          open={filterOpen}
