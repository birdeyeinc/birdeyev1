...
export function ConversationDetailHeader({
  ...
  return (
    <div
      className={cn(
        "relative z-10 shrink-0 bg-gray-10 px-5 transition-[box-shadow,colors] duration-200 dark:bg-app-shell-gutter",
        chatHeaderElevated
    ...
    >
      <div className="flex flex-col gap-2 py-4">
        <div className="flex min-w-0 items-start justify-between gap-4">
          <h2
            className="min-w-0 text-[16px] text-gray-900 dark:text-foreground"
          ...
          <div className="flex shrink-0 flex-wrap items-center justify-end gap-2">
            ...
            <button
              type="button"
              className="flex items-center gap-2 rounded-lg px-2 py-1 transition-colors hover:bg-gray-20 dark:hover:bg-muted"
            >
              ...
              <ChevronDown
                className="size-3.5 text-gray-90 dark:text-muted-foreground"
                strokeWidth={L1_STRIP_ICON_STROKE_PX}
                absoluteStrokeWidth
                aria-hidden
              />
            ...
            <Button
              ...
              variant="ghost"
              size="icon"
              className="rounded-lg hover:bg-gray-20 dark:hover:bg-muted"
              aria-label="More options"
            >
              <MoreVertical
                className="size-[14px] text-gray-900 dark:text-foreground"
                strokeWidth={L1_STRIP_ICON_STROKE_PX}
                absoluteStrokeWidth
              />
            </Button>
        ...
        {(headerMetaLine || callOutcome || categoryTag) && (
          <div className="flex min-w-0 flex-wrap items-center gap-2">
            {headerMetaLine ? (
              <span className="text-[12px] text-gray-200 dark:text-muted-foreground">{headerMetaLine}</span>
            ) : null}
