...
/**
 * Underline text tabs: each tab uses a 2px bottom border (primary or transparent)
 * with `-mb-px` for the active indicator; no full-width baseline rule on the row.
 */
      ...
      {items.map((item) => {
        ...
        return (
          <button
            ...
            className={cn(
              "-mb-px inline-flex items-center gap-2 px-2 pb-2 pt-1 text-[length:var(--font-size)] font-medium leading-normal transition-colors",
              isActive
