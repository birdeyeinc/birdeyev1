            ...
            <div className="flex items-center gap-2">
              {searchOpen ? (
                <div className="relative h-[var(--button-height)] w-[min(100%,240px)] min-w-[200px] shrink">
                  <Search
                    className="pointer-events-none absolute top-1/2 left-2 size-[14px] -translate-y-1/2 text-gray-600 dark:text-muted-foreground"
                    strokeWidth={1.6}
                    absoluteStrokeWidth
                    aria-hidden
                  />
              ...
              <Button type="button" variant="outline" size="icon" aria-label="More options" title="More options">
                <MoreHorizontal className="size-[14px] text-gray-600 dark:text-muted-foreground" strokeWidth={1.6} absoluteStrokeWidth aria-hidden />
              </Button>
            </div>
          }
        />
