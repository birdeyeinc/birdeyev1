...
export function HorizontalResizeHandle({
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-y-0 left-1/2 w-[2px] -translate-x-1/2 bg-transparent transition-colors duration-150 group-hover:bg-brand-color/20 group-active:bg-brand-color/40 dark:group-hover:bg-blue-80/25 dark:group-active:bg-blue-80/50" />
    </div>
  );
}
