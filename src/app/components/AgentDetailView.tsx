...
function StatusBadge({ status }: { status: AgentInstance["status"] }) {
  const config = {
    active: { label: "Active", dot: "bg-green-100", bg: "bg-green-20 dark:bg-green-400", text: "text-green-200 dark:text-green-70" },
    paused: { label: "Paused", dot: "bg-yellow-100", bg: "bg-yellow-20 dark:bg-yellow-800", text: "text-yellow-300 dark:text-yellow-80" },
    error: { label: "Error", dot: "bg-red-80", bg: "bg-red-20 dark:bg-red-400", text: "text-red-200 dark:text-red-80" },
    draft: { label: "Draft", dot: "bg-gray-90", bg: "bg-gray-20 dark:bg-gray-700", text: "text-gray-100 dark:text-gray-90" },
  };
...
function AgentConfigModal({ agent, onClose }: AgentConfigModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative bg-white dark:bg-background border border-new-selected-color dark:border-border rounded-[12px] shadow-xl w-[560px] max-h-[85vh] overflow-hidden flex flex-col">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-new-selected-color dark:border-border">
          <h2 className="text-[16px] text-gray-900 dark:text-foreground tracking-[-0.32px]" style={{ fontWeight: 400 }}>
            Agent configuration
          </h2>
          <Button
            type="button"
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="text-[12px] text-gray-90 dark:text-muted-foreground font-regular">
          ...
          {/* Name field */}
          <div>
            <label className="block text-[12px] text-gray-80 dark:text-muted-foreground mb-1.5" style={{ fontWeight: 400 }}>
              Agent name
            </label>
            <input
              type="text"
              ...
              className="w-full h-[38px] px-3 bg-white dark:bg-muted border border-new-selected-color dark:border-border rounded-[8px] text-[13px] text-gray-900 dark:text-foreground outline-none focus:border-brand-color dark:focus:border-brand-color transition-colors"
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-3 py-2.5 bg-white dark:bg-muted border border-new-selected-color dark:border-border rounded-[8px] text-[13px] text-gray-900 dark:text-foreground outline-none focus:border-brand-color dark:focus:border-brand-color transition-colors resize-none"
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="flex items-center gap-2 text-[13px] text-gray-900 dark:text-foreground"
                style={{ fontWeight: 400 }}
              >
                {status === "active" ? (
                  <ToggleRight className="w-5 h-5 text-brand-color" />
                ) : (
                  <ToggleLeft className="w-5 h-5 text-gray-90 dark:text-muted-foreground" />
                )}
          ...
          {/* Performance metrics */}
          <div>
            <label className="block text-[12px] text-gray-80 dark:text-muted-foreground mb-2" style={{ fontWeight: 400 }}>
              Performance
            </label>
            <div className="grid grid-cols-3 gap-3">
              <div className="bg-gray-10 dark:bg-muted border border-new-selected-color dark:border-border rounded-[8px] px-3 py-2.5">
                <div className="flex items-baseline gap-1.5 mb-1">
                  <p className="text-[16px] text-gray-900 dark:text-foreground" style={{ fontWeight: 400 }}>{agent.tasksToday}</p>
                  <Zap className="w-3 h-3 text-brand-color self-center" />
                </div>
                <span className="text-[10px] text-gray-80 dark:text-muted-foreground" style={{ fontWeight: 400 }}>Tasks today</span>
              </div>
              <div className="bg-gray-10 dark:bg-muted border border-new-selected-color dark:border-border rounded-[8px] px-3 py-2.5">
                <div className="flex items-baseline gap-1.5 mb-1">
                  <p className="text-[16px] text-gray-900 dark:text-foreground" style={{ fontWeight: 400 }}>{agent.successRate}%</p>
                  <TrendingUp className="w-3 h-3 text-green-100 self-center" />
                </div>
                <span className="text-[10px] text-gray-80 dark:text-muted-foreground" style={{ fontWeight: 400 }}>Success rate</span>
              </div>
              <div className="bg-gray-10 dark:bg-muted border border-new-selected-color dark:border-border rounded-[8px] px-3 py-2.5">
                <div className="flex items-baseline gap-1.5 mb-1">
                  <p className="text-[13px] text-gray-900 dark:text-foreground mt-0.5" style={{ fontWeight: 400 }}>{agent.lastRun}</p>
                  <Clock className="w-3 h-3 text-gray-80 self-center" />
                </div>
                <span className="text-[10px] text-gray-80 dark:text-muted-foreground" style={{ fontWeight: 400 }}>Last run</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-2 bg-gray-10 dark:bg-muted border border-new-selected-color dark:border-border rounded-[8px] px-3 py-2.5">
              <Calendar className="w-4 h-4 text-gray-80 dark:text-muted-foreground" />
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {["Google", "Yelp", "Facebook", "TripAdvisor"].map(ch => (
                <span key={ch} className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-gray-10 dark:bg-muted border border-new-selected-color dark:border-border rounded-full text-[12px] text-gray-300 dark:text-muted-foreground" style={{ fontWeight: 400 }}>
          ...
          <div>
            ...
            <div className="border border-new-selected-color dark:border-border rounded-[8px] divide-y divide-light-grayish-blue dark:divide-border">
              {[
                ...
                <div key={i} className="flex items-center gap-3 px-3 py-2.5">
                  <History className="w-3.5 h-3.5 text-gray-80 dark:text-muted-foreground shrink-0" />
                  <div className="flex-1 min-w-0">
                    <span className="text-[12px] text-gray-900 dark:text-foreground" style={{ fontWeight: 400 }}>{a.action}</span>
                  </div>
                  <span className="text-[11px] text-gray-90 dark:text-muted-foreground shrink-0 font-regular">{a.time}</span>
                  {a.ok ? (
                    <CheckCircle2 className="w-3.5 h-3.5 text-green-100 shrink-0" />
                  ) : (
                    <Clock className="w-3.5 h-3.5 text-yellow-100 shrink-0" />
                  )}
                </div>
              ))}
            </div>
        ...
        {/* Footer */}
        <div className="flex items-center justify-between px-6 py-4 border-t border-new-selected-color dark:border-border">
          <div className="flex items-center gap-2">
            <Button
              type="button"
              variant="outline"
              onClick={handleDuplicate}
              className="gap-1.5 rounded-[8px] text-[13px] text-gray-300 dark:text-muted-foreground"
              style={{ fontWeight: 400 }}
            >
            ...
            <Button
              ...
              className="gap-1.5 rounded-[8px] text-[13px] text-red-200 border-red-20 dark:border-red-400 hover:bg-red-20 dark:hover:bg-red-400"
              style={{ fontWeight: 400 }}
            >
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              variant="outline"
              onClick={onClose}
              className="rounded-[8px] px-4 text-[13px] text-gray-300 dark:text-muted-foreground"
              style={{ fontWeight: 400 }}
            >
              Cancel
            </Button>
            <Button
              type="button"
              onClick={handleSave}
              className="rounded-[8px] px-4 text-[13px] bg-brand-color hover:bg-brand-color text-white"
              style={{ fontWeight: 400 }}
            >
              Save changes
            </Button>
...
function AgentCard({ agent, onConfigure }: { agent: AgentInstance; onConfigure: (agent: AgentInstance) => void }) {
  ...
  return (
    <div
      className="bg-white dark:bg-background border border-new-selected-color dark:border-border rounded-[8px] p-5 hover:border-gray-70 dark:hover:border-gray-400 transition-colors group cursor-pointer"
      onClick={() => onConfigure(agent)}
    >
      <div className="flex items-start justify-between mb-3">
        <h3 className="text-[15px] text-gray-900 dark:text-foreground tracking-[-0.3px] pr-3" style={{ fontWeight: 400 }}>
          {agent.name}
        </h3>
        <StatusBadge status={agent.status} />
      </div>
      <p className="text-[13px] text-gray-300 dark:text-muted-foreground mb-4 line-clamp-2 font-regular">
        {agent.description}
      </p>
      ...
      <div className="flex items-center gap-4 mb-3">
        <div className="flex items-center gap-1.5">
          <Zap className="w-3 h-3 text-brand-color" />
      ...
      {/* Footer */}
      <div className="flex items-center justify-between pt-3 border-t border-light-grayish-blue dark:border-border">
        ...
        <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
          {agent.status === "active" ? (
            <Button type="button" variant="ghost" size="icon" onClick={handleToggleStatus} className="rounded-[6px]" title="Pause agent">
              <Pause className="w-3.5 h-3.5 text-gray-80 dark:text-muted-foreground" />
            </Button>
          ) : agent.status === "paused" ? (
          ...
          <Button type="button" variant="ghost" size="icon" onClick={(e) => { e.stopPropagation(); onConfigure(agent); }} className="rounded-[6px]" title="Settings">
            <Settings className="w-3.5 h-3.5 text-gray-80 dark:text-muted-foreground" />
          </Button>
          <Button type="button" variant="ghost" size="icon" onClick={(e) => e.stopPropagation()} className="rounded-[6px]" title="More">
            <MoreHorizontal className="w-3.5 h-3.5 text-gray-80 dark:text-muted-foreground" />
          </Button>
        </div>
      </div>
    </div>
...
function AgentRow({ agent, onConfigure }: { agent: AgentInstance; onConfigure: (agent: AgentInstance) => void }) {
  ...
  return (
    <div
      className="flex items-center gap-4 px-4 py-3 border border-new-selected-color dark:border-border rounded-[8px] hover:border-gray-70 dark:hover:border-gray-400 transition-colors group bg-white dark:bg-background cursor-pointer"
      onClick={() => onConfigure(agent)}
    >
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-3 mb-0.5">
          <h3 className="text-[14px] text-gray-900 dark:text-foreground tracking-[-0.28px] truncate" style={{ fontWeight: 400 }}>
            {agent.name}
          </h3>
          <StatusBadge status={agent.status} />
        </div>
        <p className="text-[12px] text-gray-300 dark:text-muted-foreground truncate font-regular">
          {agent.description}
        </p>
      </div>
      <div className="flex items-center gap-6 shrink-0">
        <div className="text-center">
          <p className="text-[13px] text-gray-900 dark:text-foreground" style={{ fontWeight: 400 }}>{agent.tasksToday}</p>
          <p className="text-[10px] text-gray-90 dark:text-muted-foreground font-regular">Tasks today</p>
        </div>
        <div className="text-center">
          <p className="text-[13px] text-gray-900 dark:text-foreground" style={{ fontWeight: 400 }}>{agent.successRate}%</p>
          <p className="text-[10px] text-gray-90 dark:text-muted-foreground font-regular">Success</p>
        </div>
        <div className="text-center min-w-[70px]">
          <p className="text-[12px] text-gray-80 dark:text-muted-foreground font-regular">{agent.lastRun}</p>
          <p className="text-[10px] text-gray-90 dark:text-muted-foreground font-regular">Last run</p>
        </div>
        <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
          {agent.status === "active" ? (
...
function TemplateCard({ template, onUseTemplate }: { template: LibraryTemplate; onUseTemplate: (name: string) => void }) {
  return (
    <div className="bg-white dark:bg-background border border-new-selected-color dark:border-border rounded-[8px] p-7 hover:border-gray-70 dark:hover:border-gray-400 transition-colors group flex flex-col h-full">
      <div className="flex-1 flex flex-col gap-2">
        <h3 className="text-[15px] text-gray-900 dark:text-foreground tracking-[-0.3px]" style={{ fontWeight: 400 }}>
          {template.name}
        </h3>
      ...
      <div className="flex items-center justify-between mt-5 pt-4 border-t border-light-grayish-blue dark:border-border">
        <span className="text-[11px] text-gray-90 dark:text-muted-foreground px-2 py-0.5 bg-gray-20 dark:bg-muted rounded-full font-regular">
          {template.category}
        </span>
        <button
          onClick={() => onUseTemplate(template.name)}
          className="text-[12px] text-brand-color hover:text-brand-color opacity-0 group-hover:opacity-100 transition-all"
          style={{ fontWeight: 400 }}
        >
          Use template
        </button>
...
function EmptyState({ type }: { type: "agents" | "library" }) {
  return (
    <div className="flex flex-col items-center justify-center py-16">
      <div className="w-12 h-12 rounded-[12px] bg-light-grayish-blue dark:bg-muted flex items-center justify-center mb-4">
        {type === "agents" ? (
          <Activity className="w-5 h-5 text-gray-80 dark:text-muted-foreground" />
        ) : (
          <LayoutGrid className="w-5 h-5 text-gray-80 dark:text-muted-foreground" />
        )}
      </div>
  ...
  if (!config) {
    return (
      <div className="flex-1 flex items-center justify-center bg-white dark:bg-app-shell-gutter">
        <p className="text-[14px] text-gray-80 dark:text-muted-foreground font-regular">
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden bg-white dark:bg-app-shell-gutter transition-colors duration-300">
          ...
          <div className="flex items-center gap-2">
            ...
            {searchOpen ? (
              <div className="relative">
                <Search className="absolute left-2.5 top-1/2 -translate-y-1/2 w-[14px] h-[14px] text-gray-80 dark:text-muted-foreground" />
                <input
                  type="text"
                  autoFocus
                  value={searchQuery}
                  ...
                  placeholder="Search..."
                  className="h-[36px] w-[200px] pl-8 pr-3 bg-white dark:bg-muted border border-new-selected-color dark:border-border rounded-[8px] text-[13px] text-gray-900 dark:text-foreground placeholder-gray-90 dark:placeholder-gray-100 outline-none focus:border-brand-color dark:focus:border-brand-color transition-colors"
              ...
              >
                <Search className="w-[14px] h-[14px] text-gray-600 dark:text-muted-foreground" />
              </Button>
            )}

            {/* View toggle */}
            <div className="h-[36px] bg-white dark:bg-muted border border-new-selected-color dark:border-border rounded-[8px] flex items-center px-1 gap-0.5">
              <button
                onClick={() => setViewMode("grid")}
                className={`h-[24px] w-[24px] flex items-center justify-center rounded-[4px] transition-colors ${
                  viewMode === "grid"
                    ? "bg-new-selected-color dark:bg-gray-500"
                    : "hover:bg-gray-20 dark:hover:bg-muted"
                }`}
              >
                <LayoutGrid className={`w-[14px] h-[14px] ${viewMode === "grid" ? "text-gray-600 dark:text-foreground" : "text-gray-80 dark:text-muted-foreground"}`} />
              </button>
              <button
              ...
              >
                <List className={`w-[14px] h-[14px] ${viewMode === "list" ? "text-gray-600 dark:text-foreground" : "text-gray-80 dark:text-muted-foreground"}`} />
              </button>
            </div>
            ...
            >
              <Filter className={`w-[14px] h-[14px] ${filterActive ? "text-brand-color" : "text-gray-300 dark:text-muted-foreground"}`} />
            </Button>
          </div>
          }
        />
      ...
      {filterActive && activeTab === "agents" && (
        <div className="shrink-0 px-6 py-3 border-b border-new-selected-color dark:border-border bg-gray-10 dark:bg-gray-800">
          <div className="flex items-center gap-3">
            <span className="text-[12px] text-gray-80 dark:text-muted-foreground" style={{ fontWeight: 400 }}>Status:</span>
            {["all", "active", "paused", "error", "draft"].map(s => (
              <button
                ...
                className={`px-2.5 py-1 rounded-full text-[12px] transition-colors border ${
                  statusFilter === s
                    ? "bg-blue-10 dark:bg-blue-300 border-brand-color text-brand-color"
                    : "border-new-selected-color dark:border-border text-gray-300 dark:text-muted-foreground hover:bg-gray-20 dark:hover:bg-muted"
                }`}
                style={{ fontWeight: 400 }}
              >
          ...
          <div className="px-6 py-5">
            ...
            {config.agents.length > 0 && (
              <div className="grid grid-cols-4 gap-4 mb-5">
                <div className="bg-white dark:bg-background border border-new-selected-color dark:border-border rounded-[8px] px-4 py-3">
                  <div className="flex items-baseline gap-1.5 mb-1">
                    <p className="text-[20px] text-gray-900 dark:text-foreground tracking-[-0.4px]" style={{ fontWeight: 400 }}>{totalActive}</p>
                    <CheckCircle2 className="w-3.5 h-3.5 text-green-100 self-center" />
                  </div>
                  <span className="text-[11px] text-gray-80 dark:text-muted-foreground" style={{ fontWeight: 400 }}>Active</span>
                </div>
                <div className="bg-white dark:bg-background border border-new-selected-color dark:border-border rounded-[8px] px-4 py-3">
                  <div className="flex items-baseline gap-1.5 mb-1">
                    <p className="text-[20px] text-gray-900 dark:text-foreground tracking-[-0.4px]" style={{ fontWeight: 400 }}>{totalTasksToday}</p>
                    <Zap className="w-3.5 h-3.5 text-brand-color self-center" />
                  </div>
                  <span className="text-[11px] text-gray-80 dark:text-muted-foreground" style={{ fontWeight: 400 }}>Tasks today</span>
                </div>
                <div className="bg-white dark:bg-background border border-new-selected-color dark:border-border rounded-[8px] px-4 py-3">
                  <div className="flex items-baseline gap-1.5 mb-1">
                    <p className="text-[20px] text-gray-900 dark:text-foreground tracking-[-0.4px]" style={{ fontWeight: 400 }}>{avgSuccessRate}%</p>
                    <TrendingUp className="w-3.5 h-3.5 text-green-100 self-center" />
                  </div>
                  <span className="text-[11px] text-gray-80 dark:text-muted-foreground" style={{ fontWeight: 400 }}>Avg. success</span>
                </div>
                <div className="bg-white dark:bg-background border border-new-selected-color dark:border-border rounded-[8px] px-4 py-3">
                  <div className="flex items-baseline gap-1.5 mb-1">
                    <p className="text-[20px] text-gray-900 dark:text-foreground tracking-[-0.4px]" style={{ fontWeight: 400 }}>{needsAttention}</p>
                    <AlertTriangle className="w-3.5 h-3.5 text-yellow-100 self-center" />
                  </div>
                  <span className="text-[11px] text-gray-80 dark:text-muted-foreground" style={{ fontWeight: 400 }}>Needs attention</span>
                </div>
              </div>
            )}
