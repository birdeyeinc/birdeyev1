...
function ToolItem({ tool, onClick }) {
  ...
  return (
    ...
    >
      ...
      <span style={{ flex: 1, fontSize: 14, lineHeight: '20px', letterSpacing: '-0.28px', color: 'var(--gray-900)', fontFamily: font }}>
        {tool.name}
      </span>
      <div style={{ display: 'flex', gap: 12, alignItems: 'center', opacity: hovered ? 1 : 0, transition: 'opacity 0.15s' }}>
        <span className="material-symbols-outlined" style={{ fontSize: 16, color: 'var(--gray-300)' }}>edit</span>
        <span className="material-symbols-outlined" style={{ fontSize: 16, color: 'var(--gray-300)' }}>sync</span>
      </div>
    </button>
  );
}
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
        {isGeneric && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
            <span style={{ fontSize: 12, fontWeight: 400, lineHeight: '18px', letterSpacing: '-0.24px', color: 'var(--gray-900)', fontFamily: font }}>
              Entity <span style={{ color: 'var(--red-100)' }}>*</span>
            </span>
            <Select
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
          <span style={{ fontSize: 12, fontWeight: 400, lineHeight: '18px', letterSpacing: '-0.24px', color: 'var(--gray-900)', fontFamily: font }}>
            Task <span style={{ color: 'var(--red-100)' }}>*</span>
          </span>
          <Select
