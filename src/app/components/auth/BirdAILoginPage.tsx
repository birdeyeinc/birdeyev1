...
const VALID_EMAIL = "futureofbirdeye";
const VALID_PASSWORD = "fob2026livenow";
...
export function BirdAILoginPage({ onAuthenticated }: BirdAILoginPageProps) {
  ...
  const handleContinue = (e: React.FormEvent) => {
    ...
    if (view === "password") {
      ...
      setTimeout(() => {
        ...
        const emailOk = email.toLowerCase().trim() === VALID_EMAIL;
  ...
  const SocialSection = (
    <div className="flex w-full flex-col gap-2">
      ...
      <SocialButton provider="sso" disabled />
    </div>
  );
                ...
                <div className="flex w-full max-w-[320px] flex-col items-center gap-6">
                      ...
                      {view === "password" && (
                        <div className="flex items-center justify-end">
                          <button
                            type="button"
                            disabled
                            className="text-sm text-primary opacity-40 cursor-not-allowed"
                          >
                            Forgot password?
                          </button>
                        </div>
                  ...
                  <p className="text-center text-sm text-muted-foreground">
                    ...
                    <button
                      type="button"
                      disabled
                      className="font-medium text-primary opacity-40 cursor-not-allowed"
                    >
                      Sign up
                    </button>
                  </p>
