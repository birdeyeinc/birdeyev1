...
export const SETTINGS_SECTIONS: SettingsSection[] = [
  ...
  },
  {
    ...
    items: [
      { key: "google",       label: "Google",                description: "Connect Google Business profiles to sync reviews, posts, and Q&A.",                   icon: ic(GlobeL, "text-google-bg"),       status: { type: "disconnected", label: "7 pages disconnected" } },
      ...
      { key: "instagram",    label: "Instagram",             description: "Connect Instagram to schedule posts and reply to comments.",                           icon: ib(Instagram, "bg-gradient-to-br from-purple-100 via-instagram-bg to-yellow-90"),        status: { type: "disconnected", label: "2 pages disconnected" } },
      ...
      { key: "tiktok",       label: "TikTok",                description: "Connect TikTok to schedule clips and pull engagement data.",                           icon: ib(Music2, "bg-gray-900"),         status: { type: "disconnected", label: "1 page disconnected" } },
