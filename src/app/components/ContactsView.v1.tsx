        ...
        >
          <div className="flex flex-col gap-6 pb-4">
            <section className="flex flex-col gap-4">
              ...
              <Label
                htmlFor="ac-samewa"
                className="flex cursor-pointer items-center gap-2 text-[13px] font-normal leading-none"
              >
                <Checkbox
                  id="ac-samewa"
                  checked={sameWa}
                  onCheckedChange={(v) => setSameWa(v === true)}
                />
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="flex items-center gap-2">
                      ...
                      <Label htmlFor="em-fb" className="text-[13px] font-normal leading-none">
                        Feedback
                      </Label>
                    </div>
                    <div className="flex items-center gap-2">
                      <Checkbox id="em-mk" />
                      <Label htmlFor="em-mk" className="text-[13px] font-normal leading-none">
                        Marketing
                      </Label>
                    </div>
                    <div className="flex items-center gap-2">
                      <Checkbox id="em-svc" defaultChecked />
                      <Label htmlFor="em-svc" className="text-[13px] font-normal leading-none">
                        Service updates
                      </Label>
                    </div>
                  </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="flex items-center gap-2">
                      <Checkbox id="tx-fb" />
                      <Label htmlFor="tx-fb" className="text-[13px] font-normal leading-none">
                        Feedback
                      </Label>
                    </div>
                    <div className="flex items-center gap-2">
                      <Checkbox id="tx-mk" disabled />
                      <Label htmlFor="tx-mk" className="text-[13px] font-normal leading-none">
                        Marketing
                      </Label>
                    </div>
                    <div className="flex items-center gap-2">
                      <Checkbox id="tx-svc" />
                      <Label htmlFor="tx-svc" className="text-[13px] font-normal leading-none">
                        Service updates
                      </Label>
                    </div>
                  </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    <Checkbox id="wa-opt" />
                    <Label htmlFor="wa-opt" className="text-[13px] font-normal leading-none">
                      Opt in
                    </Label>
                  </div>
                </div>
